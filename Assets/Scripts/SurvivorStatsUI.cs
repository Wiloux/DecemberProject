...
public class SurvivorStatsUI : MonoBehaviour
{
    ...
    void Update()
    {
        CharaWorkBGAnim.SetBool("Chased", Player.KillerScript.CurrentTransformPlayer != null && Player.KillerScript.CurrentTransformPlayer.PlayerScript == Player && Player.KillerScript.currentState == Enemy.States.Chasing && Player.currentState != Movement.States.Dead && Player.currentState != Movement.States.Corrupted);
